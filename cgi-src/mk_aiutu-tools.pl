...
sub mk_amtophtml {
    ...
    $ottxt .= '    <meta name="DESCRIPTION" content="Aiùtami a annotari un dizziunariu sicilianu.  Help me annotate a Sicilian dictionary.">'."\n";
...
sub make_welcome_msg {
    ...
    $othtml .= '  <div class="col-m-12 col-6" style="padding: 0px 20px 0px 25px;">'."\n";
    $othtml .= "\n";
    $othtml .= '<p style="font-size: 1.2em;"><i>Mi aiuti a annotari un dizziunariu sicilianu?</i></p>'."\n";
    $othtml .= "\n";    
